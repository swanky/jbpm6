...
public class PizzaType implements Serializable {
	...
	static {
		...
		addPizzaType(Types.FOURSEASONS, new IngredientType[] { IngredientType.MOZZARELLA, IngredientType.TOMATO,
				IngredientType.ARTICHOKES, IngredientType.HAM, IngredientType.MUSHROOMS }, 6.5);

		addPizzaType(Types.SALAME,
				new IngredientType[] { IngredientType.MOZZARELLA, IngredientType.TOMATO, IngredientType.SALAME }, 5.5);

		addPizzaType(Types.NAPOLI,
				new IngredientType[] { IngredientType.MOZZARELLA, IngredientType.TOMATO, IngredientType.ANCHOVIES },
				5.5);

		addPizzaType(Types.MARGHERITA, new IngredientType[] { IngredientType.MOZZARELLA, IngredientType.TOMATO }, 5.0);

	}

	private static void addPizzaType(Types type, IngredientType[] ingredientTypes, double baseprice) {
		types.put(type, new PizzaType(type, Arrays.asList(Ingredient.getIngredients(ingredientTypes)), baseprice));
	}
