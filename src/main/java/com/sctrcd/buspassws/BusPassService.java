...
public class BusPassService {
	...
	/**
	 * Create a new session, insert a person's details and fire rules to determine what kind of bus pass is to be
	 * issued.
	 */
		...
		ObjectFilter busPassFilter = new ObjectFilter() {
			public boolean accept(Object object) {
				if (BusPass.class.equals(object.getClass()))
					return true;
				if (BusPass.class.equals(object.getClass().getSuperclass()))
					return true;
				return false;
			}
		};
